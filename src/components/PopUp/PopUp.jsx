export default function RightPopUp({update}) {
  return (
    <>
            <div className="bg-white/70 backdrop-blur-xl z-20 max-w-md absolute -right-72 top-24 rounded-lg p-6 shadow-md" ref={update}>
